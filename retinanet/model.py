...
class ClassificationModel(nn.Module):
    ...
    def forward(
        ...
        return out2.contiguous().view(x.shape[0], -1, self.num_classes) # x.shape[0] == batch_size
    ...
    **kwargs
    ...
    """ Constructs a ResNet-18 model.
        ...
        num_classes : int
            Number of classes
        pretrained : bool
            If True, returns a pre-trained model
    """
    model = ResNet(num_classes, BasicBlock, [2, 2, 2, 2], **kwargs)
    if pretrained:
        pass #model.load_state_dict("", model_dir='.'), strict=False)
    return model
